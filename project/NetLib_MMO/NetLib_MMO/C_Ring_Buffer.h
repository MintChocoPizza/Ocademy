...
private:
	size_t GetInIndex(void) { return _In; }
	size_t GetOutIndex(void) { return _Out; }
...
public:
	...
	{
		return  _Full_Size - GetUseSize(_In, _Out) - 1;
	}
private:
	size_t	GetFreeSize(size_t In, size_t Out)
	{
		return  _Full_Size - GetUseSize(In, Out) - 1;
	}
...
public:
	...
	// Return: (int)가져온 크기.
	/////////////////////////////////////////////////////////////////////////
	size_t	Peek(char* chpDest, size_t iSize);
	...
	// Return: (int)가져온 크기.
	/////////////////////////////////////////////////////////////////////////
	size_t PeekAt(char* pOutTarget, size_t out, size_t sizeToPeek);
...
public:
	size_t	DirectEnqueueSize(size_t In, size_t Out)
	{
		size_t Full_Size = _Full_Size;
	...
	size_t DirectDequeueSize(size_t In, size_t Out)
	{
		if (In >= Out)
		{
			return In - Out;
...
public:
	...
	size_t MoveInOrOutPos(size_t pos, size_t moveSize)
	{
		return (pos + moveSize) % _Full_Size;
	}
